...
router.get(`/flightsearch`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const result = yield new AmadeusMockRepo().getCheapestFlightDates("MAD", "MUC");
...
router.post(`/flightsearch`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        //readonly moqRepo: AmadeusMockRepo;
        const result = yield new AmadeusMockRepo().getCheapestFlightDates(sourceCode, destinationCode);
...
router.get(`/getAirportSuggestion`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
//# sourceMappingURL=Mockflight_controller.js.map